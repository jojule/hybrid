...
public class OfflineDetector {
	...
	/*-{
		...
		detector.@org.vaadin.hybrid.vaadinrpcoffline.client.OfflineDetector::onOnline()();
		});
		var onOffline = $entry(function() {
		detector.@org.vaadin.hybrid.vaadinrpcoffline.client.OfflineDetector::onOffline()();
		});
